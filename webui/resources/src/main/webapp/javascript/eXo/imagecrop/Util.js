...
// Image cropping plugin
    $.imageCrop = function(object, customOptions) {
        ...
        // layer
// var $nResizeHandler = $('<div class="image-crop-resize-handler"
// id="image-crop-n-resize-handler" />')
// .css({
// opacity : 0.5,
// position : 'absolute'
// })
// .insertAfter($selection);
        ...
        // layer
// var $wResizeHandler = $('<div class="image-crop-resize-handler"
// id="image-crop-w-resize-handler" />')
// .css({
// opacity : 0.5,
// position : 'absolute'
// })
// .insertAfter($selection);
        ...
        // layer
// var $eResizeHandler = $('<div class="image-crop-resize-handler"
// id="image-crop-e-resize-handler" />')
// .css({
// opacity : 0.5,
// position : 'absolute'
// })
// .insertAfter($selection);
        ...
        // layer
// var $sResizeHandler = $('<div class="image-crop-resize-handler"
// id="image-crop-s-resize-handler" />')
// .css({
// opacity : 0.5,
// position : 'absolute'
// })
// .insertAfter($selection);
        ...
        if (options.allowSelect)
            // Bind an event handler to the 'mousedown' event of the trigger
			// layer
            $trigger.mousedown(setSelection);

        if (options.allowMove)
            // Bind an event handler to the 'mousedown' event of the selection
			// layer
            $selection.mousedown(pickSelection);

        if (options.allowResize)
            // Bind an event handler to the 'mousedown' event of the resize
			// handlers
...
// cursor : 'n-resize',
// display : display,
// left : options.selectionPosition[0] + Math.round(options.selectionWidth / 2 -
// $neResizeHandler.width() / 2) - 1,
// top : options.selectionPosition[1] - Math.round($neResizeHandler.height() /
// 2)
// });
...
// cursor : 'w-resize',
// display : display,
// left : options.selectionPosition[0] - Math.round($neResizeHandler.width() /
// 2),
// top : options.selectionPosition[1] + Math.round(options.selectionHeight / 2 -
// $neResizeHandler.height() / 2) - 1
// });

// $eResizeHandler.css({
// cursor : 'e-resize',
// display : display,
// left : options.selectionPosition[0] + options.selectionWidth -
// Math.round($neResizeHandler.width() / 2) - 1,
// top : options.selectionPosition[1] + Math.round(options.selectionHeight / 2 -
// $neResizeHandler.height() / 2) - 1
// });
...
// display : display,
// left : options.selectionPosition[0] + Math.round(options.selectionWidth / 2 -
// $seResizeHandler.width() / 2) - 1,
// top : options.selectionPosition[1] + options.selectionHeight -
// Math.round($seResizeHandler.height() / 2) - 1
// });
...
// break;
        ...
        function resizeSelection(event) {
            ...
            // modified temp cause by now just support display with the same
			// width and height
